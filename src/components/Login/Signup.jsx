...
const Signup = ({show, onClose, onLoginClick, setloginFormData}) => {
  ...
  return (
    ...
    >
      <div className={`w-[min(95%,900px)] absolute top-1/2 left-1/2 -translate-x-1/2 transition-all duration-300 max-h-[80vh] ${
        show ? '-translate-y-1/2 opacity-100' : '-translate-y-[40%] opacity-0'
      }`}>
        <div className="w-full bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-[80vh]">
          <div className="flex flex-1 overflow-hidden">
            {/* Left Column - Image */}
            <div className="hidden md:block w-[400px] bg-primary-600 p-8 text-white relative overflow-y-auto">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
              <div className="p-6 sm:p-8 flex-1 overflow-y-auto">
                ...
                <button 
                  type="button" 
                  className="mt-6 w-full h-12 flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-700 font-medium border border-gray-200 rounded-xl transition-colors"
                >
