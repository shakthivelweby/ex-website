...
const PackageBookings = () => {
  ...
  return (
    <>
      {bookingsError ? (
        <BookingsError
          message={bookingsError.message || "Failed to load bookings"}
        ...
        <BookingsEmpty
          ...
          description="Start your journey today by exploring our curated collection of amazing destinations."
            ...
            {bookings.map((booking) => (
              ...
              >
                <div className="flex flex-col sm:flex-row gap-4 md:gap-5">
                  <BookingCardImage
                    src={resolveBookingImage(booking, "package")}
                    alt={booking.package?.name || "Package"}
                    fallbackIcon="fi fi-rr-backpack"
                    href={
                      booking.package?.id
